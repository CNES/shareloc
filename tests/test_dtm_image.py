...
def test_dtm_fillnodata():
    ...
    my_image_with_nodata = dtm_reader(dtm_file, read_data=True, fill_nodata=None)
    ...
    my_image_rio_fillnodata = dtm_reader(dtm_file, read_data=True, fill_nodata="rio_fillnodata")
    assert my_image_rio_fillnodata.data[nodata_index[0], nodata_index[1]] == 783

    my_image_mean = dtm_reader(dtm_file, read_data=True, fill_nodata="mean")
    assert my_image_mean.data[nodata_index[0], nodata_index[1]] == 872

    my_image_min = dtm_reader(dtm_file, read_data=True, fill_nodata="min")
    assert my_image_min.data[nodata_index[0], nodata_index[1]] == 32

    my_image_max = dtm_reader(dtm_file, read_data=True, fill_nodata="max")
    assert my_image_max.data[nodata_index[0], nodata_index[1]] == 2757

    my_image_median = dtm_reader(dtm_file, read_data=True, fill_nodata="median")
    assert my_image_median.data[nodata_index[0], nodata_index[1]] == 840

    my_image_constant = dtm_reader(dtm_file, read_data=True, fill_nodata="constant", fill_value=100.0)
    ...
    my_image_fill_hole = dtm_reader(dtm_file_srtm_hole, read_data=True, fill_nodata="rio_fillnodata")
