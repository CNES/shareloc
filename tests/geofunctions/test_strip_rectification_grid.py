...
def test_compute_strip_of_epipolar_grid_columns_lines_rectangular(
    ...
    left_grid, right_grid, alphas, mean_br_col, nan_col, _ = compute_strip_of_epipolar_grid(
        geom_model_left,
        geom_model_right,
        left_position_point,
        right_position_point,
    ...
    left_grid, right_grid, alphas, mean_br, nan_count, _ = compute_strip_of_epipolar_grid(
        geom_model_left,
        geom_model_right,
        left_grid,
        right_grid,
...
def test_compute_strip_of_epipolar_grid_lines_columns(init_inputs_rectification_fixture, init_rpc_geom_model):
    ...
    left_grid, right_grid, alphas, mean_br_line, nan_line, _ = compute_strip_of_epipolar_grid(
        geom_model_left,
        geom_model_right,
        left_position_point,
        right_position_point,
    ...
    left_grid, right_grid, _, mean_br, nan_count, _ = compute_strip_of_epipolar_grid(
        geom_model_left,
        geom_model_right,
        left_grid,
        right_grid,
...
def test_working_with_strip(init_rpc_geom_model, init_inputs_rectification_fixture):
    ...
    first_left_points, first_right_points, first_alphas, mean_br_col, nan_col, _ = compute_strip_of_epipolar_grid(
        geom_model_left,
        geom_model_right,
        left_position_point,
        right_position_point,
    ...
    for idx, left_strip in enumerate(left_strips):
        strip_left_grid, strip_right_grid, _, mbr, nan_strip, _ = compute_strip_of_epipolar_grid(
            geom_model_left,
            geom_model_right,
            left_strip,
            right_strips[idx],
