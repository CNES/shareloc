...
tuple<vector<double>,vector<double>,vector<double>> RPC::inverse_loc(
    ...
    //     }catch(...){
    //      throw runtime_error("Error : longitude/latitude not vector<double> and can't be converted");
    //     }
    //     };
    ...
    //     }catch(...){
    //         throw runtime_error("Error : altitude not vector<double> and can't be converted");
    //     }
    //     };
...
double derivative_polynomial_latitude(
    ...
    double lat_norm,
    double alt_norm,
    const std::array<double, 20>& coeff){//array<double, 20> coeff){
